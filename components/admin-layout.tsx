      ...
      <div className="flex min-h-screen">
          ...
          <SidebarHeader>
            <div className="flex items-center gap-2 px-2">
              <Link href="/" className="flex items-center space-x-2">
                <span className="text-xl font-bold text-primary">Lawfirm</span>
                <span className="text-xl font-bold">&</span>
                <span className="text-xl font-bold">Associates</span>
              </Link>
            </div>
          </SidebarHeader>
          <SidebarContent>
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={isActive("/admin/attorneys")}>
        ...
        <div className="flex-1">
          <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b bg-background px-6 ">
            <SidebarTrigger />
            <div className="ml-auto flex items-center gap-4 border-red-400">
